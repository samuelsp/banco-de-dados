...
EXPLAIN ANALYZE SELECT * FROM usuarios WHERE nome = 'Pedro Lima';

EXPLAIN ANALYZE SELECT * FROM usuarios us
...
EXPLAIN ANALYZE SELECT * FROM usuarios WHERE nome = 'Maria Santos';